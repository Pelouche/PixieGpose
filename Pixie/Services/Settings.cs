...
namespace Anamnesis.Services
{
	...
	public class Settings : INotifyPropertyChanged
	{
		...
		public string DefaultPoseDirectory { get; set; } = "%MyDocuments%/Pixie/Poses/";
		public string DefaultCharacterDirectory { get; set; } = "%MyDocuments%/Pixie/Characters/";
		public string DefaultSceneDirectory { get; set; } = "%MyDocuments%/Pixie/Scenes/";
